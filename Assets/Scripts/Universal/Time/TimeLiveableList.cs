...
namespace Universal
{
    ...
    public class TimeLiveableList<T> where T : class
    {
        ...
        [SerializeField][Min(0)] private float baseDeadTimeMultiplier = 5;
        ...
        private void MoveLiveableToDead(TimeLiveable<T> tl)
        {
            ...
            {
                timeDead.Add(tl);
                tl.IncreaseTime(baseTimeLife * baseDeadTimeMultiplier);
            }
        ...
        public void StackObjectFrame(T obj) => StackObject(obj, 1);
        /// <summary>
        ...
        {
            this.baseTimeLife = baseTimeLife;
            this.baseDeadTimeMultiplier = baseDeadTimeMultiplier;
        }
        /// <summary>
